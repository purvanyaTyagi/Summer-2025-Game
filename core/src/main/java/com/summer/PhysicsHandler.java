...
public class PhysicsHandler{
    ...
    public ClientState update_position(float delta_time){
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.A)) velocity_x -= x_control_speed;
        if (Gdx.input.isKeyPressed(Input.Keys.D)) velocity_x += x_control_speed;   
